...
import { DAILY_TARGET_ATTEMPTS, WEEKS } from "@/lib/types";
...
export default async function PlanPage() {
  ...
  return (
    <div className="space-y-4 max-w-2xl">
      <PageTitle>Plan <span className="text-muted-foreground text-base font-normal">{cur ? `· week ${cur} of ${WEEKS.length}` : "· not in program window"}</span></PageTitle>
